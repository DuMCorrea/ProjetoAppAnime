...
export const CharacterList = () => {
    const {characters, setCharacters, manualLocation} = useContext(AnimeContext)
    const {id} = useParams()
    ...
    return (
        <div className="character-list">
            ...
            characters.data.map(personagem => <div key={personagem.mal_id}> 
                <h1>{personagem.character.name}</h1>
                <img onClick={() => characterClick(personagem)} src={personagem.character.images.jpg.image_url}/>
